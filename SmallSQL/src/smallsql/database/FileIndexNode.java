...
public class FileIndexNode extends IndexNode {
	 ...
	 */
	FileIndexNode(boolean unique, char digit, RandomAccessFile file){
		super(unique, digit);
		this.file = file;
        fileOffset = -1;
	}
    ...
    static FileIndexNode loadRootNode(boolean unique, RandomAccessFile file, long offset) throws Exception{
        StorePage storePage = new StorePage( null, -1, file, offset);
